...
namespace pinprojekt.Controllers
{
    public class GuidesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var guide = await _context.Guide.Include(g => g.Group)
        ...
        public async Task<IActionResult> Create([Bind("GuideID,FirstName,LastName,Age,Rating")] Guide guide)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GuideID,FirstName,LastName,Age,Rating")] Guide guide)
        {
            if (id != guide.GuideID)
            {
                return NotFound();
